...
def main():
    ...
    if (flag):
        ...
        # print('Exporting to image... \nCheck the source folder for Fake Report')
        # export as PNG
        # export(styled_df, 'Fake_report.png')

        # print('Exporting to excel... /nCheck the source folder for Fake Report')
        # export as excel
        # styled_df.to_excel('Fake_Report.xls')
        
        st.table(styled_df)
    else:
        print("Error occured, Cross check the excel file manually... or report to Joe")
